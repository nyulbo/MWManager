...
namespace MessageBus
{
    public class ConnectionConfiguration
    {
        ...
        private void SetDefaultClientProperties(IDictionary<string, object> clientProperties)
        {
            ...
            clientProperties.Add("client_api", "MessageBus");

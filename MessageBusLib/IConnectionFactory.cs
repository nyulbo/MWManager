    ...
    public class ConnectionFactoryWrapper : IConnectionFactory
    {
        ...
        public ConnectionFactoryWrapper(ConnectionConfiguration connectionConfiguration, IClusterHostSelectionStrategy<ConnectionFactoryInfo> clusterHostSelectionStrategy)
        {
            ...
            foreach (var hostConfiguration in Configuration.Hosts)
            {
                ...
                //connectionFactory.SocketWriteTimeout = 360000;
                //connectionFactory.SocketReadTimeout = 360000;
                //connectionFactory.ContinuationTimeout = TimeSpan.FromSeconds(360);
                //Console.WriteLine(connectionFactory.ContinuationTimeout.ToString());
                //connectionFactory.HandshakeContinuationTimeout = TimeSpan.FromSeconds(360);
                //connectionFactory.RequestedConnectionTimeout = 360;
